...
from lumo.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock

SESSIONS_DIR = ".lumo/sessions"
...
class SessionMeta:
    ...
    def save(self, path: Path) -> None:
        data = {
            ...
            "runtime_snapshot_file": self.runtime_snapshot_file,
    ...
    def load(cls, path: Path) -> SessionMeta | None:
        try:
            ...
            return cls(
                ...
                scenario_id=data.get("scenario_id", "legacy-coding"),
                runtime_fingerprint=data.get("runtime_fingerprint", ""),
                runtime_snapshot_file=data.get("runtime_snapshot_file", ""),
...
class SessionManager:
    ...
    def create(
        ...
        *,
        ...
        if runtime_snapshot is not None:
            snapshot_file = f"{session_id}.runtime.json"
            (self._sessions_dir / snapshot_file).write_text(
        ...
        meta = SessionMeta(
            ...
            runtime_snapshot_file=snapshot_file,
    ...
    def delete(self, session_id: str) -> bool:
        jsonl_path = self._sessions_dir / f"{session_id}.jsonl"
        meta_path = self._sessions_dir / f"{session_id}.meta"
        runtime_path = self._sessions_dir / f"{session_id}.runtime.json"
