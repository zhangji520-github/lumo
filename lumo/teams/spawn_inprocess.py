...
from lumo.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from lumo.agent import Agent
    from lumo.conversation import ConversationManager
    from lumo.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from lumo.conversation import ConversationManager as CM
                conv = CM()
