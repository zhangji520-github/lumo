...
from lumo.teams.backend_detect import BackendDetectionError, detect_backend
from lumo.teams.mailbox import Mailbox, create_message
...
from lumo.teams.progress import TeammateProgress
from lumo.teams.registry import AgentNameRegistry
from lumo.teams.shared_task import SharedTaskStore
from lumo.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from lumo.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
