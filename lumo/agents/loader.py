...
PROJECT_AGENTS_DIR = ".lumo/agents"
USER_AGENTS_DIR = "~/.lumo/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("lumo.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from lumo.agents.parser import parse_frontmatter, _validate_agent_meta
