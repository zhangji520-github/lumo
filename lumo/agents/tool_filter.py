...
def build_teammate_tools(
    ...
    from lumo.tools.send_message import SendMessageTool
    from lumo.tools.task_create import TaskCreateTool
    from lumo.tools.task_get import TaskGetTool
    from lumo.tools.task_list import TaskListTool
    from lumo.tools.task_update import TaskUpdateTool
...
def clone_registry_for_fork(parent_registry: ToolRegistry) -> ToolRegistry:
    ...
    from lumo.tools.agent_tool import FORK_QUERY_SOURCE
