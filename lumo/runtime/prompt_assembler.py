...
from lumo.runtime.prompt_models import (
    PromptAssembly,
    PromptContribution,
...
def assemble_runtime_prompt(
    ...
    *,
    ...
    contributions = [
        PromptContribution("kernel:identity", -100, _NEUTRAL_IDENTITY, "kernel", "lumo"),
        PromptContribution("kernel:system", -90, _SYSTEM, "kernel", "lumo"),
        PromptContribution("kernel:safety", -80, _SAFETY, "kernel", "lumo"),
        PromptContribution("kernel:style", -70, _STYLE, "kernel", "lumo"),
