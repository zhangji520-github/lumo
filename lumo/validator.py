...
def validate_config_structure(raw: object) -> dict:
    ...
    default_scenario = raw.get("default_scenario", "coding")
    if not isinstance(default_scenario, str) or not default_scenario:
        raise ConfigError("'default_scenario' must be a non-empty string")
    ...
    return {
        ...
        "default_scenario_explicit": "default_scenario" in raw,
    }
