...
class InstallSkillTool(Tool):
    """从 URL 下载并安装 skill 到用户全局目录 (~/.lumo/skills/)。
    ...
    description = (
        ...
        "(~/.lumo/skills/). Supports skills.sh URLs (https://www.skills.sh/<owner>/<repo>/<name>), "
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from lumo.skills.install import parse_skill_url, install_skill
