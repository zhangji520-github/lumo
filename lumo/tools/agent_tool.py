...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from lumo.agents.fork import ForkError, build_forked_messages
        from lumo.agents.parser import AgentDef
        from lumo.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        from lumo.agent import Agent as AgentClass
        ...
        sub_agent = AgentClass(
            ...
            runtime_persona=self._parent_agent.runtime_persona,
            runtime_spec=self._parent_agent.runtime_spec,
            provider_name=self._parent_agent.provider_name,
            model_name=self._parent_agent.model_name,
            surface=self._parent_agent.surface,
            runtime_diagnostics=self._parent_agent.runtime_diagnostics,
        )
        ...
        if p.subagent_type is None:
            from lumo.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from lumo.agents.fork import ForkError, build_forked_messages
        from lumo.agents.parser import AgentDef
        from lumo.agents.tool_filter import build_teammate_tools
        from lumo.agent import Agent as AgentClass
        from lumo.conversation import ConversationManager
        from lumo.permissions import (
            DangerousCommandDetector,
        ...
        from lumo.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from lumo.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from lumo.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from lumo.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from lumo.client import create_client
