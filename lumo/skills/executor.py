...
from lumo.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from lumo.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from lumo.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
