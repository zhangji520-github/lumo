...
class Tool(ABC):
    ...
    def permission_targets(self, arguments: dict[str, Any]) -> list[PermissionTarget]:
        """Describe resources affected by one invocation.

        Built-in tools keep the existing PermissionChecker extraction fallback.
        External CLI, MCP, and plugin tools should override this method.
        """
        return []
