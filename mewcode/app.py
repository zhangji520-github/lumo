...
class MewCodeApp(App):
    ...
    async def _select_provider(self, provider: ProviderConfig) -> None:
        ...
        work_dir = os.getcwd()
        try:
            from mewcode.runtime.builder import RuntimeBuilder
    ...
    def _show_scenario_manager(self) -> None:
        from mewcode.scenario_dialog import InlineScenarioWidget
    ...
    def _show_scenario_switch(self, scenario_id: str) -> None:
        from mewcode.scenario_dialog import InlineScenarioSwitchWidget
    ...
    def _show_scenario_editor(
        ...
        from mewcode.scenario_editor import ScenarioEditorWidget
    ...
    async def _start_scenario_designer(self, description: str) -> None:
        ...
        from mewcode.scenario_designer.validation import validate_draft
        from mewcode.scenario_designer_dialog import ScenarioDraftReviewWidget
    ...
    async def _init_mcp(self) -> None:
        ...
        from mewcode.runtime.capabilities import activate_external_capabilities
        try:
